// SCDE-Module ESP32_TouchGUI1_Module (GUI with touch)

#ifndef ESP32_TouchGUI1_MODULE_H
#define ESP32_TouchGUI1_MODULE_H
...
SCDERoot_t* SCDERoot_at_ESP32_TouchGUI1_M;

// stores SCDEFn (Functions / callbacks) provided for operation - at/for this Module
SCDEFn_t* SCDEFn_at_ESP32_TouchGUI1_M;
...
//========================
esp_err_t disp_deselect(ESP32_TouchGUI1_Definition_t* ESP32_TouchGUI1_Definition);

// Activate display's CS line and configure SPI interface if necessary
//======================
esp_err_t disp_select(ESP32_TouchGUI1_Definition_t* ESP32_TouchGUI1_Definition);


// Find maximum spi clock for successful read from display RAM
// ** Must be used AFTER the display is initialized **
//======================
uint32_t find_rd_speed(ESP32_TouchGUI1_Definition_t* ESP32_TouchGUI1_Definition);
...
//============================================================
int stmpe610_get_touch(ESP32_TouchGUI1_Definition_t* ESP32_TouchGUI1_Definition, uint16_t *x, uint16_t *y, uint16_t *z);
...
//strTextMultiple_t* ESP32_TouchGUI1_DirectWrite(Common_Definition_t *Common_Definition_Stage1, Common_Definition_t *Common_Definition_Stage2, Common_StageXCHG_t *Common_StageXCHG);

int ESP32_TouchGUI1_IdleCb(Common_Definition_t *Common_Definition);

int ESP32_TouchGUI1_Initialize(SCDERoot_t* SCDERoot);

strTextMultiple_t* ESP32_TouchGUI1_Set(Common_Definition_t* Common_Definition, uint8_t *setArgs, size_t setArgsLen);

strTextMultiple_t* ESP32_TouchGUI1_Shutdown(Common_Definition_t* Common_Definition);

strTextMultiple_t* ESP32_TouchGUI1_Undefine(Common_Definition_t* Common_Definition);

xMultipleStringSLTQE_t* ESP32_TouchGUI1_Write(Common_Definition_t *Common_Definition, xString_t data);
 ...
 */
strTextMultiple_t* ESP32_TouchGUI1_ProcessKVInputArgs(ESP32_TouchGUI1_Definition_t* ESP32_TouchGUI1_Definition, parsedKVInputArgs_t *parsedKVInput, uint8_t *argsText, size_t argsTextLen);

bool ESP32_TouchGUI1_SetAffectedReadings(ESP32_TouchGUI1_Definition_t* ESP32_TouchGUI1_Definition, uint64_t affectedReadings);



#endif /*ESP32_TouchGUI1_MODULE_H*/
