...
ESP32_TouchGUI1_Attribute(Common_Definition_t* p_entry_definition,
	 const String_t attr_command,
	 const String_t attr_name,
	 const String_t attr_value)
{
  // make common ptr to modul specific ptr
  ESP32_TouchGUI1_Definition_t* p_entry_esp32_touchgui1_definition =
		  (ESP32_TouchGUI1_Definition_t*) p_entry_definition;
...
// -------------------------------------------------------------------------------------------------
  ...
  SCDEFn_at_ESP32_TouchGUI1_M->Log3Fn(p_entry_esp32_touchgui1_definition->common.name,
	p_entry_esp32_touchgui1_definition->common.nameLen,
	5,
	"Attribute Fn (Module '%.*s') is called with args: "
	"attr_command '%.*s' attr_name '%.*s' attr_value '%.*s'",
	p_entry_esp32_touchgui1_definition->common.module->provided->typeNameLen,
	p_entry_esp32_touchgui1_definition->common.module->provided->typeName,attr_command.len,
	attr_command.p_char,
  	attr_name.len,
	attr_name.p_char,
	attr_value.len,
