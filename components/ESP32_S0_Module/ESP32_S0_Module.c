/* #################################################################################################
 *
 *  ESP32_S0_Module for SCDE (Smart Connected Device Engine)
 *
 *  S0 -> S0 Feature.
 *  It is used to analyze impulses at GPIOs (hi/lo level) with the goal to count them (S0 Power Meter,
 *  S0 Gas meter, ...). The ESP32 SoC GPIO will be connected to the Counter-Hardware.
