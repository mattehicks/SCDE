...
// --- now the custom module fuctions ---
  ...
  ESP32_SPI_spi_set_speed,			// ?
  ESP32_SPI_spi_device_select,			// ?
  ESP32_SPI_spi_device_deselect,		// ?
  ESP32_SPI_spi_uses_native_pins,		// ?
  ESP32_SPI_spi_get_native_pins,		// ?
  ESP32_SPI_spi_transfer_data,			// ?
  ESP32_SPI_spi_device_TakeSemaphore,		// ?
  ESP32_SPI_spi_device_GiveSemaphore,		// ?
  ESP32_SPI_spi_setup_dma_desc_links,		// ?
...
//--------------------------------------------------------------------------------------------
bool IRAM_ATTR 
spi_lobo_dmaworkaround_req_reset(int dmachan, dmaworkaround_cb_t cb, void *arg)
{
...
//-----------------------------------------------------
void IRAM_ATTR
ESP32_SPI_spi_dmaworkaround_idle(int dmachan) {
...
//----------------------------------------------------------------
void IRAM_ATTR
ESP32_SPI_spi_dmaworkaround_transfer_active(int dmachan)
{
  portENTER_CRITICAL(&dmaworkaround_mux);
...
spi_set_clock(spi_dev_t *hw, int fapb, int hz, int duty_cycle) {
...
//--------------------------------------------------------------------------------
esp_err_t IRAM_ATTR 
ESP32_SPI_spi_device_TakeSemaphore(ESP32_SPI_Module_spi_device_handle_t handle)
{
...
//---------------------------------------------------------------------------
void IRAM_ATTR
ESP32_SPI_spi_device_GiveSemaphore(ESP32_SPI_Module_spi_device_handle_t handle)
{
...
//-------------------------------------------------------------------
void ESP32_SPI_spi_get_native_pins(int host,
	int *sdi,
	int *sdo,
	int *sck)
{
	...
	ESP32_SPI_Module_spi_transaction_t *trans)
{
	...
	if (do_deselect) {
		...
		ret = ESP32_SPI_spi_device_deselect(handle);
		if (ret) return ret;
	}
