...
// ESP32_I2C_Master_SET_SIG_OUT_EN -> 'MODE' -> SLAVE|MASTER
SelectAData ESP32_I2C_Master_MODE[] = {  //ID, Text MAX CGI LEN BEACHTEN!!!
  {0,"SLAVE"},
  {1,"MASTER"}, 
  {0, NULL}
  };
...
enum ESP32_I2C_Master_SET_IK {				// Bit #XX for debugging
  ...
  // S0 calculation configuration
    ESP32_I2C_Master_SET_MODE = 0			// Bit #00 'MODE' -> SLAVE|MASTER
  , ESP32_I2C_Master_SET_NUMBER				// Bit #01 'NUMBER'  ->  0-1

  , ESP32_I2C_Master_SET_SDA_IO				// Bit #02 'SDA_IO'  -> 
  , ESP32_I2C_Master_SET_SDA_PULLUP			// Bit #03 'SDA_PULLUP'  -> 

  , ESP32_I2C_Master_SET_SCL_IO				// Bit #04 'SCL_IO'  -> 
  , ESP32_I2C_Master_SET_SCL_PULLUP			// Bit #05 'SCL_PULLUP'  -> 

  , ESP32_I2C_Master_SET_NAME				// Bit #06 'NAME'  -> 
  , ESP32_I2C_Master_SET_CAPS				// Bit #07 'CAPS'  -> 

  // Block #01 PWM configuration
  , ESP32_I2C_Master_SET_GPIO				// Bit #08 'CHPIN' -> 
...
// for usage 
   { ESP32_I2C_Master_R_DUTY | ESP32_I2C_Master_R_RESOLUTION														, "MODE" }		// #00
  ,{ ESP32_I2C_Master_R_DUTY | ESP32_I2C_Master_R_RESOLUTION														, "NUMBER" }		// #01
  ,{ ESP32_I2C_Master_R_DUTY | ESP32_I2C_Master_R_RESOLUTION														, "SDA_IO" }		// #02
  ,{ ESP32_I2C_Master_R_DUTY | ESP32_I2C_Master_R_RESOLUTION														, "SDA_PULLUP" }		// #03
  ,{ ESP32_I2C_Master_R_DUTY | ESP32_I2C_Master_R_RESOLUTION														, "SCL_IO" }		// #04
  ,{ ESP32_I2C_Master_R_DUTY | ESP32_I2C_Master_R_RESOLUTION														, "SCL_PULLUP" }		// #05
...
// ------------------------------------------------------------------------------------------------
  ...
  if (ESP32_I2C_Master_ProcessKVInputArgs(ESP32_I2C_Master_Definition
    ,parsedKVInput				// KV-Input args parsed to mem
    ,defArgsText				// KV-Input args text
    ,defArgsTextLen) ) {			// KV-Input args text len
...
// ------------------------------------------------------------------------------------------------
  ...
  // free allocated memory storing parsed Key-Value input
  free(parsedKVInput);
