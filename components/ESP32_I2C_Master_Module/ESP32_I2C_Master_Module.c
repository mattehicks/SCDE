...
printf("*****ERRORxx***\n");
        ...
        p_i2c = (i2c_obj_t*) calloc(1, sizeof(i2c_obj_t));
	...
	if( !(intr_alloc_flags & ESP_INTR_FLAG_IRAM) ) {
		...
		p_i2c = (i2c_obj_t*) heap_caps_calloc(1,
...
static
esp_err_t i2c_hw_enable(i2c_port_t i2c_num)
{
...
esp_err_t 
i2c_driver_delete(i2c_obj_t *p_i2c)
{
